...
/-!
# Self-enforcing blocking (working-paper appendix)

**Working-paper definition and proposition (self-enforcing blocking).**
Robustness of the one-shot blocking test: under each of the existence regimes
...
/-- **Working-paper definition (self-enforcing blocking coalition).** A
...
/-- **Working-paper proposition (self-enforcing blocking), case (a).** Under
...
/-- **Working-paper proposition (self-enforcing blocking), case (b).** Under
...
/-- **Working-paper proposition (self-enforcing blocking), case (c).** Under
