...
Formalizes the two corollaries of Proposition 3 in Section 6.4 of the paper,
built on top of the payoff-degradation machinery of `Degrading`:

* `free_disposal_existence` — free disposal (Definition 18) alone gives
...
* `ra_degradable_existence` — cheap-talk copies (M-CT) together with
  revelation aversion (Definition 20) give existence, since revelation
  aversion implies decomposability (Definition 19).
-/
...
/-! ## Revelation aversion implies decomposability (Proposition 3, analytic core) -/
...
/-- Revelation aversion (Definition 20) implies decomposability
(Definition 19); part of Proposition 3. -/
...
/-- **Proposition 3** (free disposal): if the sender has free disposal
(Definition 18), a coalition-proof PBE exists, with no assumption on the
message mapping. -/
...
/-- **Proposition 3** (revelation averse): if the message mapping has
cheap-talk copies (M-CT) and the sender is revelation averse
(Definition 20), a coalition-proof PBE exists. -/
